...
import com.wwr.apipost.util.psi.PsiFieldUtils;
...
import static com.wwr.apipost.parse.util.NotificationUtils.notifyWarning;
...
public class KernelParser {
    ...
    public KernelParser(Project project, Module module, ApiPostConfig settings, boolean isResponse) {
