...
import static com.wwr.apipost.parse.constant.SpringConstants.*;
...
public class RequestParser {
    ...
    public RequestParser(Project project, Module module, ApiPostConfig settings) {
    ...
    private List<ParameterAnnotationPair> getRequestBodyParamParameters(List<PsiParameter> parameters) {
        // 自定义@RequestBody类型
        ApiPostConfig.RequestBodyParamType type = settings.getRequestBodyParamType();
        if (type == null) {
    ...
    private List<PsiParameter> filterRequestParameters(List<PsiParameter> parameters) {
        return parameters.stream()
                ...
                .filter(p -> {
                    ...
                    ApiPostConfig.RequestBodyParamType requestBodyParamType = settings.getRequestBodyParamType();
